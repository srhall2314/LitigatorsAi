...
export default async function HeavyAnalysisLandingPage() {
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-black text-lg">
              Run comprehensive citation analysis using Claude Sonnet. Select a file to begin.
            </p>
          </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-2">
                          {hasJson ? (
                            <a
                              href={`/citation-checker/${file.id}/heavy-analysis`}
