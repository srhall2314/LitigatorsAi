...
import { IdentifyCitationsPage } from "../../components/IdentifyCitationsPage"
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <StepProgress 
            ...
            completedSteps={new Set(["upload", "generate-json"])}
          ...
          <div className="border border-gray-200 rounded-lg p-8 bg-white">
            <div className="mb-6">
              ...
              <p className="text-black text-gray-600">
                Extract and identify all citations from the document
              </p>
            </div>
            <IdentifyCitationsPage fileId={params.fileId} />
          </div>
        </div>
      </main>
      <Footer />
